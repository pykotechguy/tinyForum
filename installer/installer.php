<?php if(!defined('INST_BASEDIR')) die('Installer cannot be started directly!'); 
	...
	require('assets'.DIRECTORY_SEPARATOR.'class.PasswordHash.php');
						...
						&& $_REQUEST['create'] == 'administrator')
					{
						...
						**************************************************************************************/
						...
						if($validData)
						{
							...
							$keywords['admin']['admin_password'] = $hasher->HashPassword( mysql_real_escape_string( $data['admin_password'] ) );
