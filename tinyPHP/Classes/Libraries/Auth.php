...
class Auth {
	...
	public static function is_valid_password($x,$y) {
	...
	public static function generate_user_password($length = 7) {
  		$password = "";
  		...
  		return $password;
		//return apply_filter('user_password',$possible,$length);
	}
	...
	public static function login_error() {
		...
		//return apply_filter( 'login_error', $error );
	}
