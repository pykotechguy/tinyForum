...
class Topic extends \tinyPHP\Classes\Core\Controller {
	...
	public function success() {
		$this->view->staticTitle = array('Topic Saved Successfully');
		$this->view->render('header/index',true);
		$this->view->render('topic/success',true);
	...
	public function create() {
		...
		$this->view->staticTitle = array('Create a Topic');
		$this->view->render('header/index',true);
		$this->view->render('topic/create',true);
		$this->view->render('footer/index',true);
	}
	...
	public function edit($id) {
		...
		$this->view->dynamicTitle = $this->model->editDynamicTopicTitle($id);
		$this->view->cats = $this->model->listCats();
		$this->view->editTopic = $this->model->singleTopic($id);
		$this->view->css = array('markitup/skins/markitup/style.css','markitup/sets/html/style.css');
		$this->view->js = array('markitup/jquery.markitup.js','markitup/sets/html/set.js');
		$this->view->render('header/index',true);
		$this->view->render('topic/edit',true);
		$this->view->render('footer/index',true);
	}
