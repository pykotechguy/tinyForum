...
<div class="reply-obj">
	...
	<div class="t2"></div>
	<div class="box01">
		<form method="post" action="<?php echo BASE_URL; ?>settings/save" id="settings">
		...
		<div><?php _e( _t( 'Cookie Path:' ) ); ?> <input class="text" name="cookiepath" value="<?php echo $hook->get_option('cookiepath'); ?>" /></div>
		...
		<div><?php _e( _t( 'Cache TTL:' ) ); ?> <input class="text" name="cacheTTL" value="<?php echo $hook->get_option('cacheTTL'); ?>" /> <?php _e( _t( 'cache time to live in seconds' ) ); ?></div>
