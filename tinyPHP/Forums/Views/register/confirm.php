...
<div class="success-obj">
	<div class="box01">
	<span class="s1"><?php _e( _t( 'Confirmation' ) ); ?></span><?php _e( _t( 'Your account is active. You may now login with your username and password.' ) ); ?>
	</div>
</div>